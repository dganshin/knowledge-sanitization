...
test_forget_kf="${python_dir}/data/triviaqa_${num}/test-forget_gold-answer_K-F"
test_forget_ks="${python_dir}/data/triviaqa_${num}/test-forget_sanitization-phrase_K-S"
test_retain_kr="${python_dir}/data/triviaqa_${num}/test-retrain_K-R"
